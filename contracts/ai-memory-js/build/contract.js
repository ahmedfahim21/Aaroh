 ...
 * - Profile/preferences
 */
let AiMemory = (_dec = NearBindgen({}), _dec2 = initialize(), _dec3 = call({}), _dec4 = view(), _dec5 = call({}), _dec6 = call({}), _dec7 = call({}), _dec8 = call({}), _dec9 = call({}), _dec0 = view(), _dec1 = call({}), _dec10 = call({}), _dec11 = view(), _dec12 = view(), _dec13 = call({}), _dec14 = view(), _dec15 = call({}), _dec16 = call({}), _dec17 = view(), _dec18 = call({}), _dec19 = view(), _dec20 = view(), _dec21 = view(), _dec(_class = (_class2 = class AiMemory {
  constructor() {
    this.owner = '';
  ...
  get_cart({
    ...
    const user = account_id || signerAccountId();
  ...
  add_cart_item({
    ...
    if (cart) {
      ...
      cart.updated_at = blockTimestamp();
    } else {
      // Create new cart
      cart = {
        items: [item],
  ...
  append_messages({
    ...
    if (conversation) {
      ...
      conversation.updated_at = blockTimestamp();
      this.userConversations.set(key, conversation);
    } else {
  ...
  list_conversations({
    ...
    for (let i = from_index; i < from_index + limit; i++) {
      const keys = this.userConversations.keys({
        start: i,
        limit: 1
      });
...
}, _applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "save_cart", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "save_cart"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_cart", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "get_cart"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "clear_cart", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "clear_cart"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "add_cart_item", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "add_cart_item"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "remove_cart_item", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "remove_cart_item"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "update_cart_item_quantity", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "update_cart_item_quantity"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "save_conversation", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "save_conversation"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_conversation", [_dec0], Object.getOwnPropertyDescriptor(_class2.prototype, "get_conversation"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "delete_conversation", [_dec1], Object.getOwnPropertyDescriptor(_class2.prototype, "delete_conversation"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "append_messages", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "append_messages"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "list_conversations", [_dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "list_conversations"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_conversations_count", [_dec12], Object.getOwnPropertyDescriptor(_class2.prototype, "get_conversations_count"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_profile_field", [_dec13], Object.getOwnPropertyDescriptor(_class2.prototype, "set_profile_field"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_profile_field", [_dec14], Object.getOwnPropertyDescriptor(_class2.prototype, "get_profile_field"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "delete_profile_field", [_dec15], Object.getOwnPropertyDescriptor(_class2.prototype, "delete_profile_field"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "update_ai_context", [_dec16], Object.getOwnPropertyDescriptor(_class2.prototype, "update_ai_context"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_ai_context", [_dec17], Object.getOwnPropertyDescriptor(_class2.prototype, "get_ai_context"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_preferences", [_dec18], Object.getOwnPropertyDescriptor(_class2.prototype, "set_preferences"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_preferences", [_dec19], Object.getOwnPropertyDescriptor(_class2.prototype, "get_preferences"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_owner", [_dec20], Object.getOwnPropertyDescriptor(_class2.prototype, "get_owner"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_storage_stats", [_dec21], Object.getOwnPropertyDescriptor(_class2.prototype, "get_storage_stats"), _class2.prototype), _class2)) || _class);
function get_storage_stats() {
  const _state = AiMemory._getState();
  if (!_state && AiMemory._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = AiMemory._create();
  if (_state) {
    AiMemory._reconstruct(_contract, _state);
  }
  const _args = AiMemory._getArgs();
  const _result = _contract.get_storage_stats(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function get_owner() {
  const _state = AiMemory._getState();
  if (!_state && AiMemory._requireInit()) {
...
function get_preferences() {
  ...
  const _args = AiMemory._getArgs();
  const _result = _contract.get_preferences(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function set_preferences() {
  ...
  const _args = AiMemory._getArgs();
  const _result = _contract.set_preferences(_args);
  AiMemory._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function get_ai_context() {
  const _state = AiMemory._getState();
  if (!_state && AiMemory._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = AiMemory._getArgs();
  const _result = _contract.get_ai_context(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function update_ai_context() {
  const _state = AiMemory._getState();
  if (!_state && AiMemory._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = AiMemory._getArgs();
  const _result = _contract.update_ai_context(_args);
  AiMemory._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function delete_profile_field() {
  ...
  const _args = AiMemory._getArgs();
  const _result = _contract.delete_profile_field(_args);
  AiMemory._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function get_profile_field() {
  ...
  const _args = AiMemory._getArgs();
  const _result = _contract.get_profile_field(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function set_profile_field() {
  const _state = AiMemory._getState();
  if (!_state && AiMemory._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = AiMemory._getArgs();
  const _result = _contract.set_profile_field(_args);
  AiMemory._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function get_conversations_count() {
  ...
  const _args = AiMemory._getArgs();
  const _result = _contract.get_conversations_count(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function list_conversations() {
  ...
  const _args = AiMemory._getArgs();
  const _result = _contract.list_conversations(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function append_messages() {
  ...
  const _args = AiMemory._getArgs();
  const _result = _contract.append_messages(_args);
  AiMemory._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function delete_conversation() {
  ...
  const _args = AiMemory._getArgs();
  const _result = _contract.delete_conversation(_args);
  AiMemory._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function get_conversation() {
  ...
  const _args = AiMemory._getArgs();
  const _result = _contract.get_conversation(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function save_conversation() {
  ...
  const _args = AiMemory._getArgs();
  const _result = _contract.save_conversation(_args);
  AiMemory._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function update_cart_item_quantity() {
  ...
  const _args = AiMemory._getArgs();
  const _result = _contract.update_cart_item_quantity(_args);
  AiMemory._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function remove_cart_item() {
  ...
  const _args = AiMemory._getArgs();
  const _result = _contract.remove_cart_item(_args);
  AiMemory._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function add_cart_item() {
  ...
  const _args = AiMemory._getArgs();
  const _result = _contract.add_cart_item(_args);
  AiMemory._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function clear_cart() {
  ...
  const _args = AiMemory._getArgs();
  const _result = _contract.clear_cart(_args);
  AiMemory._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function get_cart() {
  ...
  const _args = AiMemory._getArgs();
  const _result = _contract.get_cart(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function save_cart() {
  const _state = AiMemory._getState();
  ...
  const _args = AiMemory._getArgs();
  const _result = _contract.save_cart(_args);
  AiMemory._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AiMemory._serialize(_result, true));
}
function init() {
...
export { add_cart_item, append_messages, clear_cart, delete_conversation, delete_profile_field, get_ai_context, get_cart, get_conversation, get_conversations_count, get_owner, get_preferences, get_profile_field, get_storage_stats, init, list_conversations, remove_cart_item, save_cart, save_conversation, set_preferences, set_profile_field, update_ai_context, update_cart_item_quantity };
